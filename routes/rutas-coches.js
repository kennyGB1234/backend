...
router.post('/:id/publicar', async (req, res, next) => {
  const usuarioId = req.params.id; // Obtener el ID del usuario del cuerpo de la petición
  try {
    ...
    usuario.publicados.push(nuevoCoche); // Agregar el ID del nuevo coche a la matriz de coches publicados del usuario
